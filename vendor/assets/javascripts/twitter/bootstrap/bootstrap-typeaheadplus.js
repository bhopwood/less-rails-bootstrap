...
function ($) {
  ...
  var _defaults = {
    ...
    Typeaheadplus = function (element, options) {
      this.$element = $(element);
      this.options = $.extend(true, {}, $.fn.typeaheadplus.defaults, options);
  ...
  Typeaheadplus.prototype = {

      constructor: Typeaheadplus,
  ...
  //  Plugin definition
  $.fn.typeaheadplus = function (option) {
    return this.each(function () {
      var $this = $(this),
          data = $this.data('typeaheadplus'),
          options = typeof option === 'object' && option;

      if (!data) {
          $this.data('typeaheadplus', (data = new Typeaheadplus(this, options)));
      }
  ...
  $.fn.typeaheadplus.defaults = _defaults;
  $.fn.typeaheadplus.Constructor = Typeaheadplus;

  //  Data API (no-JS implementation)
  $(function () {
    $('body').on('focus.typeaheadplus.data-api', '[data-provide="typeaheadplus"]', function (e) {
      var $this = $(this);
      if ($this.data('typeaheadplus')) return;
      e.preventDefault();
      $this.typeaheadplus($this.data());
    })
  });
} (window.jQuery);
